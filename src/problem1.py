...
def problem1a(rectangle, square, thickness, window):
    ...
    if rectangle.corner_2.x > rectangle.corner_1.x:
        x = rectangle.corner_1.x + (rectangle.corner_2.x - rectangle.corner_1.x) / 2
    else:
        x = rectangle.corner_2.x + (rectangle.corner_1.x - rectangle.corner_2.x) / 2
