...
def problem2a_testing():
    ...
    ############################################################################
    #  DONE Implement this TEST function.  See the IMPORTANT NOTE below.
...
################################################################################
# DONE  READ the green doc-string for the   number_of_factors   function
...
def problem2b(a, b, x):
    ...
    Examples:
     ...
     """
    ############################################################################
    # DONE Implement and test this function.  See the IMPORTANT NOTE below!
